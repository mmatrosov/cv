...
\textwidth=13cm  % To make sure full job title fits in one line
...
\newcommand{\Habrahabr}{\includegraphics[height=1em]{habr.png}}

% My custom httplink command with underlined text
\newcommand*{\myhttplink}[2][]{\href{#2}{\dotuline{#1}}}
...
\social[twitter]{cppjedi}
\extrainfo{
	\StackExchange\httplink[Mikhail]{stackoverflow.com/users/261217/mikhail} \\ \Habrahabr\,\httplink[mmatrosov]{habrahabr.ru/users/mmatrosov/}
}
