...
\cvitem{from~2017\cvmonth{01}}{
	...
	Полное переключение на глобальные задачи ПО, касающиеся всех разработчиков. Миграция на 64-битную платформу. Поддержка локализации. Поддержка Unicode. Архитектурная переработка: разделение модели и представления, механизм undo. Видение дальнейшего развития ПО.
}
...
\cvitem{2017\cvmonth{04}}{
	\myhttplink[\textbf{Конференция SECON'2017}]{2017.secon.ru}, \emph{Докладчик} \newline 
	Доклад \myhttplink[``Повседневный С++: алгоритмы и итераторы'']{2017.secon.ru/reports/povsednevnyy-s-algoritmy-i-iteratory}.
}
\cvitem{2017\cvmonth{02}}{
	\myhttplink[\textbf{Конференция C++ Russia 2017}]{2017.cppconf.ru}, \emph{Докладчик} \newline 
	Доклад \myhttplink[``Повседневный С++: алгоритмы и итераторы'']{2017.cppconf.ru/talks/mikhail-matrosov}.
}
\cvitem{2017\cvmonth{02}}{
	\myhttplink[\textbf{Конференция C++ CoreHard 2017}]{corehard.by/category/corehard-conf-winter-2017/}, \emph{Докладчик} \newline 
	Доклад \myhttplink[``Повседневный С++: алгоритмы и итераторы'']{corehard.by/2017/02/20/day-to-day-c-algorithms-and-iterators/}.
}
\cvitem{2016\cvmonth{02}}{
	\myhttplink[\textbf{Конференция C++ Russia 2016}]{cpp-russia.ru/?page_id=936}, \emph{Докладчик} \newline 
	Доклад \myhttplink[<<Повседневный С++: boost и STL>>]{cpp-russia.ru/?page_id=999}.
}
\cvitem{2016\cvmonth{02}}{
	\myhttplink[\textbf{Конференция C++ CoreHard 2016}]{corehard.by/category/corehard-conf-2016/}, \emph{Докладчик} \newline 
	Доклад \myhttplink[<<Повседневный С++: boost и STL>>]{corehard.by/2016/02/15/conf2016-daily-cpp/}.
}
\cvitem{2015\cvmonth{10}}{
	\myhttplink[\textbf{Конференция CEE-SECR 2015}]{2015.secr.ru/}, \emph{Докладчик} \newline 
	Доклад \myhttplink[<<Повседневный С++>>]{2015.secr.ru/lang/ru/program/submitted-presentations/daily-cpp}.
}
...
\cvitem{2015\cvmonth{02}}{
	\myhttplink[\textbf{Конференция C++ Russia 2015}]{cpp-russia.ru/?page_id=233}, \emph{Докладчик} \newline 
	Доклад \myhttplink[<<С++ without new and delete>>]{cpp-russia.ru/?page_id=608}.
}
\cvitem{2014\cvmonth{10}}{
	\myhttplink[\textbf{Встреча C++ User Group, Russia}]{cpp-russia.ru/?p=286}, \emph{Докладчик} \newline 
	Доклад \myhttplink[<<С++ без new и delete>>]{www.slideshare.net/sermp/c-without-new-and-delete-russian-c-user-group}.
}
\cvitem{2014\cvmonth{10}}{
	\myhttplink[\textbf{KeysRemapper}]{github.com/mmatrosov/KeysRemapper}, \emph{Автор} \newline 
...
\cvitem{с~2010\cvmonth{01}}{
	...
	Более 10k репутации, \myhttplink[более 75 принятых ответов]{stackoverflow.com/search?q=user:261217+isaccepted:yes}. \newline
