...
\cvitem{from~2016\cvmonth{02}}{
	...
	Участие в миграции на 64-битную платформу. Бизнес анализ: сбор требований по новой функциональности со всех позиций, включая пользователей ПО и докторов. Межкомандное взаимодействие для успешной интеграции функционала во все компоненты системы. Продвижение компании: публичные доклады и публикации. Плюс всё то же, что и раньше.	
}
