...
\cvitem{from~2017\cvmonth{01}}{
	...
	Полное переключение на глобальные задачи ПО, касающиеся всех разработчиков. Миграция на 64-битную платформу. Поддержка локализации. Поддержка Unicode. Унификация форматирования кода. Поддержка кросс-платформенности. Архитектурная переработка: разделение модели и представления. Видение дальнейшего развития ПО. Плюс прокачивание процесса разработки как и раньше.
}
