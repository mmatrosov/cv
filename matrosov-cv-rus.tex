...
\cvitem{2013--2014}{
	\textbf{OctoNus Software Ltd, проект DM}, \emph{Разработчик}. \newline 
	На проекте DM (Digital Microscope) занимался разработкой и поддержкой Qt-приложения для отображения и обработки видео-потока с сетевых камер. Развивал систему плагинов и SDK. Улучшил структуру взаимодействия модулей приложения.
}
\cvitem{с~2013/10 по~2014/10}{
...
\cvitem{2014/10}{
	\myhttplink[\textbf{C++ User Group, Russia}]{meetingcpp.ru}, \emph{Докладчик} \newline 
	Доклад \myhttplink[<<С++ без new и delete>>]{meetingcpp.ru/?p=250}.
}
\cvitem{2012/02}{
