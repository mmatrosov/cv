...
\cvitem{с~2019\cvmonth{09} по~2019\cvmonth{10}}{
	\textbf{Высшая Школа Экономики} \newline 
	Факультет Компьютерных Наук\newline
	Бакалаврская программа <<Прикладная математика и информатика>>\newline
	Основы и методология программирования (пилотный поток)\newline
	\emph{Преподаватель}. \newline
	Проведение семинарских занятий по С++ у группы 193-2. Объяснение базовых концепций языка (в дополнение к лекциям), разбор домашных заданий, разбор основ архитектуры современных процессоров, ответы на вопросы.
}
\cvitem{с~2019\cvmonth{01}}{
...
\cvitem{с~2010\cvmonth{01}}{
	...
	Более 10k репутации, \myhttplink[более 80 принятых ответов]{http://stackoverflow.com/search?q=user:261217+isaccepted:yes}. \newline
