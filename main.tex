...
Могу похвастаться \httplink[аккаунтом на StackOverflow]{stackoverflow.com/users/261217/mikhail}, \httplink[расширением NativeViewer]{sourceforge.net/projects/nativeviewer/} для Visual Studio и \httplink[патчем \#1641 для OpenCV]{code.opencv.org/issues/1641}.
...
\cvitem{ещё умею}{
	boost, Intel MKL, CGAL, ASP.NET, jQuery
}

\subsection{Прикладные программы и системы}

\cvitem{основные}{
	Visual Studio, SVN, GIT, win-batch
}
\cvitem{ещё могу}{
	\LaTeX, Photoshop, bash
}
