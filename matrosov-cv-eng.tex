...
\cvitem{from~2017\cvmonth{01}}{
	...
	Switch completely to global software problems, affecting all developers. Migration to 64-bit platform. Support for localization. Support for Unicode. Architectural rework: model/view separation, undo mechanism. Vision of the future software evolution.
}
