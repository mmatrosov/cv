...
C++ jedi. Create software and know what teamwork is. Solve problems and optimize everything. Good at communicating with people and love to teach people. Can bring order to your messy code base.
\par\medskip
...
\cvitem{primary}{
	\textbf{C++}: high-performance low-latency multi-threaded applications, 3D-graphics, image processing applications, GUI with Qt and MFC; internal and public technical talks and seminars. \newline
	\textbf{Python}: all sorts of scripts ranging from text parsing and json manipulation to automatic AWS EC2 instances set up and TCP congestion window control
}
\cvitem{secondary}{
	\textbf{Matlab}, \textbf{C\#}, \textbf{JavaScript}, \textbf{SQL}
}

\subsection{Libraries and technologies}

\cvitem{primary}{
	\textbf{STL}, \textbf{boost}, \textbf{boost.asio}, \textbf{OpenCV}, \textbf{Intel IPP}
}
\cvitem{secondary}{
	\textbf{clang-tidy}, \textbf{Microsoft ConcRT}, \textbf{Intel MKL}, \textbf{OpenSceneGraph}, \textbf{CGAL}, \textbf{ASP.NET}, \textbf{Qt}, \textbf{MFC}, \textbf{jQuery}
}

\subsection{Applications and systems}

\cvitem{}{
	\textbf{Ubuntu}, \textbf{VS Code}, \textbf{conan}, \textbf{AWS}, \textbf{Git}, \textbf{Jenkins}, \textbf{Windows}, \textbf{Visual Studio}, \textbf{Bamboo}, \textbf{SVN}
}

\subsection{Scientific and fundamental knowledge}

\cvitem{}{
	Image processing~\cite{matrosov2009diploma}, color theory~\cite{matrosov2013correction}, computer vision, computer graphics, algorithms, data structures, software design.
}

\subsection{Productivity}

\cvitem{}{
	Touch typing in both English and Russian layouts.
}


\section{Experience}

\cvitem{from~2020\cvmonth{12}}{
	\textbf{Pinely (former Aim High Tech)}, \emph{Senior developer}. \newline 
	Develop high-performance low-latency multi-threaded trading platform for high frequency trading on crypto exchanges. Create a system searching for the the best route between hosts and seamlessly switching websocket connections to the best one. Implement a component for redistributing REST requests among several network intefaces and exchange accounts to respect rate limits. Set up and maintain AWS EC2 instances. Bring some order into development chaos: create a sanity check testing system and introduce a number of unit tests for critical components, create design diagrams for the most complicated parts of the system, refactor a lot of code manually and with help of clang-tidy, introduce metrics for TCP retransmissions and congestion window size.
}
\cvitem{from~2019 till~2020}{
	\textbf{Higher School of Economics}, \emph{Lecturer}\newline 
	Practical lessons on C++ within the ``Introduction to Programming'' course of the ``Applied Mathematics and Information Science'' bachelor’s programme on the Faculty of Computer Science. \newline 
	Basic language concepts (supplementary to the lectures) and best practices. Discussion of homework and Q\&A.
}
\cvitem{from~2020\cvmonth{02} till~2020\cvmonth{09}}{
	\textbf{Align Technology Inc}, \emph{Expert developer, TPE team}. \newline 
	Integrate unit testing into development workflow. Create instructions and guidelines, give talks, communicate with different teams, implement helper utilities, regularly attend code reviews. \newline
	Create a comprehensive formal documentation for a large obscure part of the application, make the software behavior consistent. Documentation is stored as a code in AsciiDoc format and is automatically converted to Word with help of Pandoc.
}
\cvitem{from~2019\cvmonth{01} till~2020\cvmonth{01}}{
	\textbf{Align Technology Inc}, \emph{Expert developer, BMS team}. \newline 
	Extract a part of a monolith application developed by our team into a web service. The service is hosted in AWS and runs on Linux. The monolith application runs locally on Windows. Implement cloud logging with Splunk.
}
\cvitem{from~2018\cvmonth{02} till~2018\cvmonth{12}}{
	\textbf{Align Technology Inc}, \emph{Expert developer, 3D platform team}. \newline 
	Continue work in 3D platform team. Improve management of C++ third-party libraries: switching from a custom solution to Conan package manager. Technical guidance and mentoring of a team of junior developers working on cross-platform support for a subset of applications. Upgrade compiler from Visual Studio 2013 to Visual Studio 2017.
}
...
\cvitem{from~2014\cvmonth{12} till~2016\cvmonth{02}}{
	\textbf{Align Technology Inc}, \emph{Senior developer, BMS team}. \newline 
...
Talks marked with $\star$ symbol deserve to be highlighted. Talks with captions in English were given in English.

\cvitem{2021\cvmonth{11}}{
	\myhttplink[\textbf{C++ Russia 2021}]{https://2021.cppconf.ru/en/} \newline 
	\myhttplink[``Разговор в студии о С++ в HFT	'']{https://2021.cppconf.ru/en/talks/conversation-in-the-studio-about-c-in-hft/}
}
...
\cvitem{from~2019\cvmonth{04}}{
	\myhttplink[\textbf{conan}]{https://conan.io/index.html}, \emph{Contributor} \newline 
	Author of \myhttplink[a number of pull requests]{https://github.com/conan-io/conan-center-index/pulls?q=is\%3Amerged+author\%3Ammatrosov+}.
}
\cvitem{from~2019\cvmonth{02} till~2019\cvmonth{05}}{
...
\cvitem{from~2010\cvmonth{01}}{
	...
	Over 19k reputation, \myhttplink[over 90 accepted answers]{http://stackoverflow.com/search?q=user:261217+isaccepted:yes}. \newline
...
\cvitem{2020\cvmonth{02}}{
	...
	\myhttplink[Link to the certificate]{http://ude.my/UC-0d85d789-0b8b-4e9b-956f-271559b15b1c}.
}
