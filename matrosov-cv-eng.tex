...
\cvitem{from~2018\cvmonth{02}}{
	...
	Continue work in 3D platform team. Improve management of C++ third-party libraries: switching from a custom solution to Conan package manager. Technical guidance and mentoring of team of junior developers working on cross-platform support for a subset of applications.
}
