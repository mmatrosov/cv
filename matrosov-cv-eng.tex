...
\cvitem{primary}{
	\textbf{C++}: 7 years, image processing applications, multi-threaded applications, console utilities, GUI with MFC, handling devices with corresponding SDK and via COM-port. \newline
	\textbf{Matlab}: 5 years, applications prototyping, mex-interfaces.
}
\cvitem{secondary}{
	\textbf{C\#}, \textbf{JavaScript}, \textbf{HTML}, \textbf{SQL}, \textbf{PHP}: small utilities, simple web-applications.
}

\subsection{Libraries and technologies}

\cvitem{primary}{
	\textbf{OpenCV}, \textbf{Intel IPP}, \textbf{STL}, \textbf{Microsoft ConcRT}: multiple image processing projects, problems in areas of combinatorial theory, numerical analysis and graph theory.
}
\cvitem{secondary}{
	\textbf{boost}, \textbf{Intel MKL}, \textbf{CGAL}, \textbf{ASP.NET}, \textbf{jQuery}: shallow knowledge, used only in several projects.
}
...
\cvitem{since 2012}{
	\httplink[\textbf{NativeViewer}]{sourceforge.net/projects/nativeviewer/}, \emph{Author} \newline{} 
	A Visual Studio extension for visualization of OpenCV images during debug of native C++ applications. Opposed to Microsoft Image Watch, works with all version of Visual Studio.
}
\cvitem{since 2010}{
	\httplink[\textbf{StackOverflow}]{stackoverflow.com/users/261217/mikhail}, \emph{Contributor} \newline{} 
	Over 3000 reputation, over 30 accepted answers. \newline
	Top 10\% for tags \texttt{algorithm} and \texttt{image-processing}. \newline
	Top 20\% for tags \texttt{c++}, \texttt{matlab} and \texttt{opencv}.
}
\cvitem{2012}{
	\httplink[\textbf{OpenCV}]{code.opencv.org/users/915}, \emph{Contributor} \newline{} 
	\httplink[Patch \#1641]{code.opencv.org/issues/1641}. Discrete Voronoi diagram: returning closest pixel instead of connected component in distanceTransform.
}
...
\cvitem{2004--2009}{
	...
	Graduation work~\cite{matrosov2009diploma}. Won admission without matriculation because of I degree diploma in \httplink[XVI Russian Olympiad in Informatics]{neerc.ifmo.ru/school/archive/2003-2004/ru-olymp-roi-2004-standings.html}.
}
\cvitem{2001--2003}{
