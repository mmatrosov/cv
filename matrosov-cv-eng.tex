...
\par\medskip
* Letter ``k'' is not pronounced in my name, it is \textipa{[{m\super j}Ix5{\textprimstress}il]}, like \myhttplink[Gorbachev]{en.wikipedia.org/wiki/Mikhail_Gorbachev}.
...
\cvitem{primary}{
	\textbf{Windows}, \textbf{Visual Studio}, \textbf{SmartGit}, \textbf{GIT}, \textbf{SVN}, \textbf{Total Commander}
}
\cvitem{secondary}{
...
\cvitem{from~2017\cvmonth{01}}{
	\textbf{Align Technology Inc}, \emph{Technical Manager, 3D platform team}. \newline 
	Switch completely to global software problems, affecting all developers. Migration to 64-bit platform. Support for localization. Support for Unicode. Unification of code formatting. Architectural rework: model/view separation, undo mechanism. Vision of the future software evolution. Plus enhancement of development process as before.
}
...
\cvitem{2017\cvmonth{04}}{
	\myhttplink[\textbf{SECON'2017}]{2017.secon.ru}, \emph{Speaker} \newline 
	Talk \myhttplink[``Повседневный С++: алгоритмы и итераторы'']{2017.secon.ru/reports/povsednevnyy-s-algoritmy-i-iteratory}.
}
\cvitem{2017\cvmonth{02}}{
	\myhttplink[\textbf{C++ Russia 2017}]{2017.cppconf.ru}, \emph{Speaker} \newline 
	Talk \myhttplink[``Повседневный С++: алгоритмы и итераторы'']{2017.cppconf.ru/talks/mikhail-matrosov}.
}
\cvitem{2017\cvmonth{02}}{
	\myhttplink[\textbf{C++ CoreHard Winter 2017 Сonference}]{corehard.by/category/corehard-conf-winter-2017/}, \emph{Speaker} \newline 
	Talk \myhttplink[``Повседневный С++: алгоритмы и итераторы'']{corehard.by/2017/02/20/day-to-day-c-algorithms-and-iterators/}.
}
\cvitem{2016\cvmonth{02}}{
	\myhttplink[\textbf{C++ Russia 2016 Conference}]{cpp-russia.ru/?page_id=936}, \emph{Speaker} \newline 
	Talk \myhttplink[``Повседневный С++: boost и STL'']{cpp-russia.ru/?page_id=999}.
}
\cvitem{2016\cvmonth{02}}{
	\myhttplink[\textbf{C++ Corehard Conf 2016}]{corehard.by/category/corehard-conf-2016/}, \emph{Speaker} \newline 
	Talk \myhttplink[``Повседневный С++: boost и STL'']{corehard.by/2016/02/15/conf2016-daily-cpp/}.
}
\cvitem{2015\cvmonth{10}}{
	\myhttplink[\textbf{Conference CEE-SECR 2015}]{2015.secr.ru/lang/en}, \emph{Speaker} \newline 
	Talk \myhttplink[``Повседневный С++'']{2015.secr.ru/lang/en/program/submitted-presentations/daily-cpp}.
}
...
\cvitem{2015\cvmonth{02}}{
	\myhttplink[\textbf{C++ Russia 2015 Conference}]{cpp-russia.ru/?page_id=233}, \emph{Speaker} \newline 
	Talk \myhttplink[``С++ without new and delete'']{cpp-russia.ru/?page_id=608}.
}
\cvitem{2014\cvmonth{10}}{
	\myhttplink[\textbf{Meeting of C++ User Group, Russia}]{cpp-russia.ru/?p=286}, \emph{Speaker} \newline 
	Talk \myhttplink[``С++ без new и delete'']{www.slideshare.net/sermp/c-without-new-and-delete-russian-c-user-group}.
}
\cvitem{2014\cvmonth{10}}{
	\myhttplink[\textbf{KeysRemapper}]{github.com/mmatrosov/KeysRemapper}, \emph{Author} \newline 
...
\cvitem{from~2010\cvmonth{01}}{
	...
	Over 10k reputation, \myhttplink[over 75 accepted answers]{stackoverflow.com/search?q=user:261217+isaccepted:yes}. \newline
